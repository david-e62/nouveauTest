...
class Task
{
     ...
     * @var string
     *
     * @ORM\Column(name="category_task", type="string", length=75, nullable=false)
     */
    ...
    public function getCategoryTask(): ?string
    {
        return $this->categoryTask;
    }

    public function setCategoryTask(string $categoryTask): self
    {
